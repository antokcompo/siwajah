-- ============================================================
-- 021: Offline sync support
--
-- Perubahan:
--   - Update RPC absen_catat_scan_wajah: terima p_waktu_scan
--     untuk mendukung upload data offline yang tertunda.
--     Jika p_waktu_scan diberikan, skip validasi jendela waktu
--     karena validasi sudah dilakukan di client saat scan.
--
...
BEGIN
  ...
  -- Skip time window check for offline sync (already validated on client)
