-- ============================================================
-- 049: Flat Overtime Salary Formula (Jam Lembur * Upah Per Jam)
--
-- Perubahan:
--   - Menghapus perkalian 1.5x / 2.0x pada perhitungan Gaji Lembur.
--   - Formula Gaji Lembur: Total Jam Lembur Approved * (Gaji Master / 26 / 8).
--
