-- ============================================================
-- 045: Support text / dynamic slot IDs in absen_catat_scan_wajah
--
-- Perubahan:
--   - Mengubah parameter p_slot_id dari integer ke text / any element
--     sehingga jika frontend atau sync offline mengirimkan "dynamic-pulang-lembur",
--     fungsi tidak akan crash dengan error: "invalid input syntax for type integer".
--   - Otomatis melakukan query slot integer ID yang sesuai dari tabel absen_jadwal_slot.
--
...
DROP FUNCTION IF EXISTS absen_catat_scan_wajah(uuid, integer, text, text, text, text, numeric, numeric, numeric, text, timestamptz);
...
DROP FUNCTION IF EXISTS absen_catat_scan_wajah(uuid, integer, text, text, text, text, numeric, numeric, numeric, text, boolean, numeric, integer, text, timestamptz);
DROP FUNCTION IF EXISTS absen_catat_scan_wajah(uuid, text, text, text, text, text, numeric, numeric, numeric, text, boolean, numeric, integer, text, timestamptz);
