-- ============================================================
-- 044: Fix RPC absen_catat_scan_wajah untuk Sinkronisasi Offline & Fake GPS
--
-- Perubahan:
--   - Menambahkan kembali parameter p_waktu_scan timestamptz DEFAULT NULL
--     agar data absen tersimpan offline (IndexedDB) dapat terkirim tanpa error schema cache.
--   - Mendukung p_is_mock_gps, p_gps_accuracy, p_fake_gps_score, p_fake_gps_reason.
--
